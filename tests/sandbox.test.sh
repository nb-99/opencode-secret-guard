...
# The documented substitutes for setuid `ps` must keep working under the profile.
expect_quiet   "pgrep works"                'pgrep -x launchd'
expect_quiet   "lsof works"                 'lsof -w -p $$ >/dev/null'
